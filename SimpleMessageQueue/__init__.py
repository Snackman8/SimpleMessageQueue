...
class SimpleXMLRPCServerBlocking(SimpleXMLRPCServer):
    def __init__(self, addr, *args, **kwargs):
        super().__init__(addr, *args, **kwargs)
        self._shutdown = False
...
class SMQServer():
    ...
    def publish_message(self, client_info, msg, msg_data, direct_smq_uid=None):
        try:
            ...
            logging.info(f'publishing message from {cuid}')
            ...
            for c in client_ids:
                ...
                if msg in ci['sub_list']:
                    ...
                    try:
                        ...
                        logging.info(f'Forwarding message Finished {msg} to {c}')
#                    except (ConnectionRefusedError, http.client.CannotSendRequest):
    ...
    def _thread_worker(cls, addr, args, kwargs):
        ...
        server = SimpleXMLRPCServerBlocking(addr, *args, **kwargs)
...
class SMQClient():
    ...
    def start_client(self, smq_server, client_name, pub_list_str, sub_list_str, message_handler=None):
        ...
        try:
            ...
            self._restart_info = {'smq_server': smq_server, 'client_name': client_name,
                                  'pub_list_str': pub_list_str, 'sub_list_str': sub_list_str,
            ...
            self._local_rpc_server = SimpleXMLRPCServerBlocking(('', 0), allow_none=True, logRequests=False)
    ...
    def receive_message(self, sender_smq_uid, msg, msg_data):
        ...
        try:
            ...
            logging.info(f'Received Message Finished "{msg}"')
        except Exception as e:
            self._connected = False
            raise(e)
    ...
    def shutdown(self):
        ...
        # sanity check
        try:
            logging.info(f"smq client shutdown {self._client_info['smq_uid']}")
